...
class Config {
  ...
  public ELASTIC_AMP_SERVER_URL: string | undefined;
  public ELASTIC_AMP_SECRET_TOKEN: string | undefined;
  ...
  constructor() {
    ...
    this.ELASTIC_AMP_SERVER_URL = process.env.ELASTIC_AMP_SERVER_URL || '';
    this.ELASTIC_AMP_SECRET_TOKEN = process.env.ELASTIC_AMP_SECRET_TOKEN || '';
  }
}
